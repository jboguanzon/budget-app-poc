...
DATABASES = {
    "default": {
        "ENGINE": env.str("DATABASE_BACKEND", default="django.db.backends.postgresql"),
...
SPECTACULAR_SETTINGS = {
    "TITLE": "budget-app-poc API",
    "DESCRIPTION": "Documentation of API endpoints of budget-app-poc",
    "VERSION": "1.0.0",
